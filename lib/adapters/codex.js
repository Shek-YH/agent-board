...
module.exports = {
  ID, ROOT, isSessionFile, parseLines, completionHoldMsForHistory, isDefinitiveContinuationLine, fileToSessionId: sessionIdFromPath, detect, reconcileRecentCompletions,
  scanAll(store) {
