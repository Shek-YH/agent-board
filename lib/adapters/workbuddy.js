...
// WorkBuddy 自带 SQLite 状态是会话级终态的更强信号；数据库不可读时保持 JSONL/心跳兜底。
...
module.exports = {
  ID, ROOT, isSessionFile, parseLines, scanHeartbeats, scanSessionStatuses, checkDesktopIdle, fileToSessionId, detect,
