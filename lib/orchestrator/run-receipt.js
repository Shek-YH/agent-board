...
function buildRunReceipt({ workflow, finalState, stopReason = null, now = Date.now(), decision = null } = {}) {
  ...
  const receipt = {
    ...
    settingsSnapshotId: safeText(workflow.settingsSnapshot && workflow.settingsSnapshot.snapshotId, 100) || null,
    permissionSnapshotId: safeText(workflow.permissionSnapshot && workflow.permissionSnapshot.snapshotId, 100) || null,
