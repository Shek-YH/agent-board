...
const DEFAULT_SETTINGS = Object.freeze({
  ...
  safety: Object.freeze({
    ...
    researchRead: false,
    allowedResearchDomains: Object.freeze([]),
    allowInstall: false,
    allowGitPush: false,
...
function normalizeSettings(input = {}) {
  ...
  const normalized = {
    ...
    safety: {
      ...
      allowedResearchDomains: safeStringList(safety.allowedResearchDomains, DEFAULT_SETTINGS.safety.allowedResearchDomains, 100, 253),
