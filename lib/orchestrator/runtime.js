...
function createOrchestrationRuntime({
  ...
  supervisorReview, evidenceCollector,
} = {}) {
  ...
  return {
    store, settings, sessionStore, runner, auto, routing, suggestion, transport, allowedRoots,
    sessionProvisioners: sessionProvisioners || {}, taskDrafts: new Map(),
    headlessEnabled: transport.enabled, env, notify,
  };
}
