...
function setup({ dispatchResult, routingRuntime = null, verifyDeliveryFingerprint = null, reconcileEveryTurns, dod = ['测试通过'], completionDetector, bindingTitle = '' } = {}) {
  ...
  return { dir, store, workflow, loop, dependencies, sessionRequests, sends: () => sends };
}
