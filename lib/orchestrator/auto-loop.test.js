...
function setup({ dispatchResult, routingRuntime = null, verifyDeliveryFingerprint = null, reconcileEveryTurns, dod = ['测试通过'], completionDetector, bindingTitle = '', bindingTransport = '', sessionMessages = [] } = {}) {
