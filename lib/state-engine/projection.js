...
function projectUiStatus(runtime) {
  ...
  if (
    runtime.turnState === TURN_STATES.COMPLETION_CANDIDATE
    && runtime.activeToolIds.length === 0
    && runtime.activeSubagentIds.length === 0
  ) return status('completion_candidate', '正在确认完成', 'active', runtime);
