...
const AUTH_CACHE_PATH = path.join(DATA_ROOT, 'AgentBoard', 'auth.json');
...
function isValidAuthCache(cache) {
  return (
    ...
    Object.prototype.hasOwnProperty.call(cache, 'token') &&
    Object.prototype.hasOwnProperty.call(cache, 'receivedAt') &&
