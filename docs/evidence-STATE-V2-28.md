...
- Literal `main` ordinary `npm test` — exit 0, 1387 tests, 1384 passed, 3 skipped, 0 failed; the extra 16 tests come from the two preserved untracked package output directories.
- `npm run lint` — exit 0.
